...
public abstract class SocketClient {
     ...
     * @deprecated This method will be removed after v0.12.0. If you want to connect via a proxy, you can do this by injecting a {@link SocketFactory}
     *             into the SocketClient. The SocketFactory should create sockets using the {@link Socket#Socket(Proxy)} constructor.
     */
    @Deprecated
